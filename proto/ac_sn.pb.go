...
func file_ac_sn_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ac_sn_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ac_sn_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ac_sn_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ac_sn_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ac_sn_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ac_sn_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
