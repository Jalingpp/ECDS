...
func (c *storjSNServiceClient) StorjPutFile(ctx context.Context, in *StorjPutFRequest, opts ...grpc.CallOption) (*StorjPutFResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjSNService_StorjPutFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjSNServiceClient) StorjGetFile(ctx context.Context, in *StorjGetFRequest, opts ...grpc.CallOption) (*StorjGetFResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjSNService_StorjGetFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjSNServiceClient) StorjUpdateFile(ctx context.Context, in *StorjUpdFRequest, opts ...grpc.CallOption) (*StorjUpdFResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjSNService_StorjUpdateFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStorjSNServiceServer must be embedded to have
...
func RegisterStorjSNServiceServer(s grpc.ServiceRegistrar, srv StorjSNServiceServer) {
	// If the following call pancis, it indicates UnimplementedStorjSNServiceServer was
