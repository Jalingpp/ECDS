...
func (c *storjSNServiceClient) StorjPutFile(ctx context.Context, in *StorjPutFRequest, opts ...grpc.CallOption) (*StorjPutFResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.StorjSNService/StorjPutFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjSNServiceClient) StorjGetFile(ctx context.Context, in *StorjGetFRequest, opts ...grpc.CallOption) (*StorjGetFResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.StorjSNService/StorjGetFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjSNServiceClient) StorjUpdateFile(ctx context.Context, in *StorjUpdFRequest, opts ...grpc.CallOption) (*StorjUpdFResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.StorjSNService/StorjUpdateFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjSNServiceClient) StorjGetSNStorageCost(ctx context.Context, in *StorjGSNSCRequest, opts ...grpc.CallOption) (*StorjGSNSCResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.StorjSNService/StorjGetSNStorageCost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StorjSNService_StorjPutFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.StorjSNService/StorjPutFile",
	}
...
func _StorjSNService_StorjGetFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.StorjSNService/StorjGetFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StorjSNService_StorjUpdateFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.StorjSNService/StorjUpdateFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StorjSNService_StorjGetSNStorageCost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.StorjSNService/StorjGetSNStorageCost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
