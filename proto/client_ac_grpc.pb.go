...
func (c *aCServiceClient) GetParamsG(ctx context.Context, in *GetPGRequest, opts ...grpc.CallOption) (*GetPGResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_GetParamsG_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) RegisterAC(ctx context.Context, in *RegistACRequest, opts ...grpc.CallOption) (*RegistACResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_RegisterAC_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) SelectSNs(ctx context.Context, in *StorageRequest, opts ...grpc.CallOption) (*StorageResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_SelectSNs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) PutFileCommit(ctx context.Context, in *PFCRequest, opts ...grpc.CallOption) (*PFCResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PFCResponse)
	err := c.cc.Invoke(ctx, ACService_PutFileCommit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) GetFileSNs(ctx context.Context, in *GFACRequest, opts ...grpc.CallOption) (*GFACResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_GetFileSNs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) GetDSErrReport(ctx context.Context, in *GDSERequest, opts ...grpc.CallOption) (*GDSEResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_GetDSErrReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) GetDSSn(ctx context.Context, in *GDSSNRequest, opts ...grpc.CallOption) (*GDSSNResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_GetDSSn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCServiceClient) UpdateDSCommit(ctx context.Context, in *UDSCRequest, opts ...grpc.CallOption) (*UDSCResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACService_UpdateDSCommit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterACServiceServer(s grpc.ServiceRegistrar, srv ACServiceServer) {
	// If the following call pancis, it indicates UnimplementedACServiceServer was
