...
func (c *storjACServiceClient) StorjSelectSNs(ctx context.Context, in *StorjStorageRequest, opts ...grpc.CallOption) (*StorjStorageResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjACService_StorjSelectSNs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjACServiceClient) StorjPutFileCommit(ctx context.Context, in *StorjPFCRequest, opts ...grpc.CallOption) (*StorjPFCResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjACService_StorjPutFileCommit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjACServiceClient) StorjGetFileSNs(ctx context.Context, in *StorjGFACRequest, opts ...grpc.CallOption) (*StorjGFACResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjACService_StorjGetFileSNs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjACServiceClient) StorjGetRandRoot(ctx context.Context, in *StorjGRRRequest, opts ...grpc.CallOption) (*StorjGRRResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjACService_StorjGetRandRoot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjACServiceClient) StorjUpdateFileReq(ctx context.Context, in *StorjUFRequest, opts ...grpc.CallOption) (*StorjUFResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjACService_StorjUpdateFileReq_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storjACServiceClient) StorjUpdateFileCommit(ctx context.Context, in *StorjUFCRequest, opts ...grpc.CallOption) (*StorjUFCResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorjACService_StorjUpdateFileCommit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStorjACServiceServer must be embedded to have
...
func (UnimplementedStorjACServiceServer) testEmbeddedByValue()                        {}
...
func RegisterStorjACServiceServer(s grpc.ServiceRegistrar, srv StorjACServiceServer) {
	// If the following call pancis, it indicates UnimplementedStorjACServiceServer was
