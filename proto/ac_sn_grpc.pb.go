...
func (c *sNACServiceClient) PutDataShardNotice(ctx context.Context, in *ClientStorageRequest, opts ...grpc.CallOption) (*ClientStorageResponse, error) {
	...
	err := c.cc.Invoke(ctx, SNACService_PutDataShardNotice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sNACServiceClient) UpdateDataShardNotice(ctx context.Context, in *ClientUpdDSRequest, opts ...grpc.CallOption) (*ClientUpdDSResponse, error) {
	...
	err := c.cc.Invoke(ctx, SNACService_UpdateDataShardNotice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sNACServiceClient) ACRegisterSN(ctx context.Context, in *ACRegistSNRequest, opts ...grpc.CallOption) (*ACRegistSNResponse, error) {
	...
	err := c.cc.Invoke(ctx, SNACService_ACRegisterSN_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sNACServiceClient) PreAuditSN(ctx context.Context, in *PASNRequest, opts ...grpc.CallOption) (*PASNResponse, error) {
	...
	err := c.cc.Invoke(ctx, SNACService_PreAuditSN_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sNACServiceClient) GetAggPosSN(ctx context.Context, in *GAPSNRequest, opts ...grpc.CallOption) (*GAPSNResponse, error) {
	...
	err := c.cc.Invoke(ctx, SNACService_GetAggPosSN_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSNACServiceServer must be embedded to have
...
func (UnimplementedSNACServiceServer) testEmbeddedByValue()                     {}
...
func RegisterSNACServiceServer(s grpc.ServiceRegistrar, srv SNACServiceServer) {
	// If the following call pancis, it indicates UnimplementedSNACServiceServer was
